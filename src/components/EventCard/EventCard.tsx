      ...
      <div className="border border-outline-variant/30 p-5 bg-brand-clay/5 flex flex-col gap-3 hover:border-brand-black hover:shadow-sm transition-all duration-200">
        <div className="flex justify-between items-baseline flex-wrap gap-2">
          <div className="flex items-center gap-3">
            ...
            {isLive && (
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1.5 bg-green-500/10 border border-green-500/25 px-2 py-0.5 text-green-600 dark:text-green-500 font-geist-mono text-[10px] font-bold tracking-wider" data-testid="live-indicator">
                ...
                <a
                  ...
                  className="font-geist-mono text-xs text-green-600 hover:underline flex items-center gap-0.5"
