...
Composition & Subject: The visual focus is on a single, extremely simple, cute, and slightly amusing visual metaphor representing the article. The metaphor must be drawn with a few clean, simple pencil outlines and very light graphite shading. Keep the illustration extremely simple and clean, using only a single cute character, object, or interaction to convey the general idea at a glance.
 ...
 - If the article is about a funding round, investment, or money (e.g. "$30 million"), draw a simple, cute representation of a money bag, a coin stack, or a country-specific currency symbol (like the Indian Rupee "₹" symbol) with the amount (e.g. "$30M" or "₹2.5B") neatly handwritten next to it.
 - If the article highlights a specific country or region (e.g. "Indian tech tycoon"), try to incorporate a simple, cute regional symbol (such as a small Indian flag outline, the Indian Rupee "₹" symbol, or a simple country map sketch) to give the metaphor immediate context.
